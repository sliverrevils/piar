...
export interface IItem {
    ...
    dimensions: {
        //Габариты
        length: number; //Ширина или Глубина (W/D) – измеряется от передней части сиденья до задней спинки.
        width: number; //Длина (L) – измеряется по самой длинной стороне дивана, обычно от одного подлокотника до другого.
